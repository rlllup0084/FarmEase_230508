...
namespace FarmEase_230508.Blazor.Server.Editors.TreeListEditor {
    ...
    public class TreeListEditor : ListEditor, IComplexListEditor {
        ...
        protected override void OnControlsCreated() {
            if (Control is TreeListHolder holder) {
                ...
                holder.ComponentModel.FieldNames = new string[] { nameof(ITreeNode.Name), "Description", "Seq", "Days", "TotalDays", "RecType", "RecValue" };
