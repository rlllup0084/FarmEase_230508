...
namespace FarmEase_230508.Maui.Services {
    public class CropCycleService : ICropCycleService {
        ...
        private readonly string _apiUrl = ON.Platform(android: "http://192.168.1.205:5000/CustomCropTasks/CropCycle/", iOS: "http://192.168.1.205:5000/CustomCropTasks/CropCycle/");
        ...
        public async Task<string> GetCropCycleById(int Id) {
            var request = new HttpRequestMessage(HttpMethod.Get, $"http://192.168.1.205:5000/api/odata/CropCycle({Id})");
        ...
        public async Task<string> GetCropCycleTasksById(int Id) {
            var request = new HttpRequestMessage(HttpMethod.Get, $"http://192.168.1.205:5000/CustomCropTasks/CropCycleTasks/{Id}");
